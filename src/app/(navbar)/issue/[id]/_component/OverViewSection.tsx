...
export default function OverViewSection({
    ...
    return (
        ...
        >
            ...
            <p className="text-base font-normal text-gray-400 mt-2">Reference Links:</p>
               ...
               {content.contribution.links.map((item, i) => (
                    ...
                    >
                        ...
                        <h6
                        className="text-gray-500 text-sm font-normal line-clamp-1"
                        >
                            {item}
                        </h6>
                    </a>
               ...
               <a
                    className="w-fit mt-2 border px-4 py-2 bg-primaryRed text-white rounded-md hover:bg-primaryRed/90 shadow-md"
                    href={content.contribution["discussion-link"]}
                    >
                        <h6 className="text-gray-100 text-center text-md font-medium">Discussion Link</h6>
                </a>
