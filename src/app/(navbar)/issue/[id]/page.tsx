...
export default async function page({ params }: { params: { id: string } }){
    ...
    return (
        ...
        <div className=' bg-gray-100'>
          <div className='px-[4rem] lg:px-[8rem] pt-[1.5rem] items-center'>
            <div className=' flex'>
      ...
      </svg> <div className='pl-1'>
      Home
      </div>
       
        </a>
        <div className='pl-2.5 text-gray-700'>
        /
        </div>
        ...
        <hr className='my-4 border-t border-gray-300' />
          ...
          <div className='px-[4rem] lg:px-[8rem] py-[1.5rem] flex justify-center w-screen'>
            
        <ScrollSpy/>

        <div className='w-3/4'>
            
            <section className='px-8 bg-white p-4 rounded-md shadow-md items-center w-auto mx-10 '>
                <div className='text-3xl font-bold my-4 '>
                Delegation Quest SDK Mission Request
                </div>
                <hr className='my-6  border-t border-gray-300' />
                <p className=' text-gray-500'>This initiative aims to continue the development of open-source infrastructure for the Optimism Collective towards strategically enabling the governance-related incentives to achieve objectives of: increasing OP votable supply, increasing active OP delegations, and rewarding beneficial delegate behavior (including participation and involvement).</p>
                
                <div className='flex items-center mt-2 flex-wrap gap-4'>
                  <p className='text-gray-700'>Label</p>
                  <div className='bg-red-50 text-sm text-red-600 p-2 rounded-full shadow-md  justify-center items-center flex '>Delegate mission request</div>
                  <h6 className='bg-gray-50 text-sm text-gray-600 p-2 rounded-full shadow-md justify-center items-center flex'>S5: Intent 4 - Improve governance accessibility sadasds</h6>
                  <div className='bg-gray-50 text-sm text-gray-600 p-2 rounded-full shadow-md justify-center items-center flex '>Medium Effort</div>
                </div>
            </section>
            ...
            <section className='bg-white p-4 rounded-md shadow-md items-center w-auto mx-10 my-6'>
                ...
                <hr className='my-6 mx-4 border-t border-gray-300' />
                <div className='mx-4 text-gray-500 flex'>
                  Proposing Delegate:<p className='font-bold'>&nbsp;Rabbithole</p>
                  </div>
                  <div className='mx-4 text-gray-500 flex'>
                  Proposal&nbsp;<p className='text-decoration-line: underline'>Tier</p>:&nbsp;<p className='text-decoration-line: underline'>Fledgling</p>
                  </div>
                  <div className='mx-4 text-gray-500 flex'>
                  Baseline grant amount:<p className='font-bold'>&nbsp;200,000 OP</p>
                  </div>
                  <div className='mx-4 text-gray-500 flex'>
                  Should this Foundation Mission be fulfilled by one or multiple applicants:<p className='font-bold'>&nbsp;Multiple</p>
                  </div>
